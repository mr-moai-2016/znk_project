...
* [無用なホストへの接続をブロックする(ignored_host機能)](#ignored_host) 
* [POST時の確認メッセージ表示(post_confirm機能)](#post_confirm)
* [LAN内における他のマシンからの接続を許可/制限する](#accept_from_others)
...
## <a name="ignored_host">無用なホストへの接続をブロックする(ignored_host機能) 
-----------------------------------
作成中.


## <a name="master_confirm">POST時の確認メッセージ表示(post_confirm機能) 
-----------------------------------
作成中.


## <a name="accept_from_others">LAN内における他のマシンからの接続を許可/制限する
-----------------------------------
作成中.
