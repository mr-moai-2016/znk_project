...
static const EVP_CIPHER chacha20_cipher = {
	Znk_DOTINIT( nid, NID_chacha20 ),
	Znk_DOTINIT( block_size, 1 ),
	Znk_DOTINIT( key_len, 32 ),
	Znk_DOTINIT( iv_len, 8 ),
	Znk_DOTINIT( flags, EVP_CIPH_STREAM_CIPHER ),
	Znk_DOTINIT( init, chacha_init ),
	Znk_DOTINIT( do_cipher, chacha_cipher ),
	Znk_DOTINIT( cleanup, NULL ),
	Znk_DOTINIT( ctx_size, sizeof(ChaCha_ctx) ),
};
