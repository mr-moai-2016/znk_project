...
static COMP_METHOD zlib_method_nozlib = {
	Znk_DOTINIT( type, NID_undef ),
	Znk_DOTINIT( name, "(undef)" ),
	Znk_DOTINIT( init,     NULL ),
	Znk_DOTINIT( finish,   NULL ),
	Znk_DOTINIT( compress, NULL ),
	Znk_DOTINIT( expand,   NULL ),
};
...
static COMP_METHOD zlib_stateful_method = {
	Znk_DOTINIT( type,     NID_zlib_compression ),
	Znk_DOTINIT( name,     LN_zlib_compression ),
	Znk_DOTINIT( init,     zlib_stateful_init ),
	Znk_DOTINIT( finish,   zlib_stateful_finish ),
	Znk_DOTINIT( compress, zlib_stateful_compress_block ),
	Znk_DOTINIT( expand,   zlib_stateful_expand_block ),
};
