...
BASENAME0=crypto
DLIB_NAME0=cygcrypto-43.dll
DLIB_FILE0=$O/$(DLIB_NAME0)
ILIB_FILE0=$O/cygcrypto-43.dll
...
$(DLIB_FILE0): $(OBJS0) $(SLIB_FILE0)
	...
	@echo gcc -shared -o $(DLIB_FILE0) {[objs]} $(SUB_LIBS)  -lpthread -ldl -lstdc++  -lc
	@     gcc -shared -o $(DLIB_FILE0) $(OBJS0) $(SUB_LIBS)  -lpthread -ldl -lstdc++  -lc
