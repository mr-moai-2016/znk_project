...
static BIO_METHOD bio_cb_method = {
	...
	Znk_DOTINIT( name, "libtls_callbacks" ),
	Znk_DOTINIT( bwrite, bio_cb_write ),
	Znk_DOTINIT( bread, bio_cb_read ),
	Znk_DOTINIT( bputs, bio_cb_puts ),
	Znk_DOTINIT( bgets, NULL ),
	Znk_DOTINIT( ctrl, bio_cb_ctrl ),
};
