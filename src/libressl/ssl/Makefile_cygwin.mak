...
BASENAME0=ssl
DLIB_NAME0=cygssl-45.dll
DLIB_FILE0=$O/$(DLIB_NAME0)
ILIB_FILE0=$O/cygssl-45.dll
...
$(DLIB_FILE0): $(OBJS0) $(SLIB_FILE0)
	...
	@echo gcc -shared -o $(DLIB_FILE0) {[objs]} $(SUB_LIBS) $(MY_LIBS_ROOT)/$(SLIBS_DIR)/libcrypto.a -lpthread -ldl -lstdc++  -lc
	@     gcc -shared -o $(DLIB_FILE0) $(OBJS0) $(SUB_LIBS) $(MY_LIBS_ROOT)/$(SLIBS_DIR)/libcrypto.a -lpthread -ldl -lstdc++  -lc
