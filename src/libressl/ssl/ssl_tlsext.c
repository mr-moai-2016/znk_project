...
static struct tls_extension tls_extensions[] = {
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_server_name ),
		Znk_DOTINIT( clienthello_needs, tlsext_sni_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_sni_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_sni_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_sni_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_sni_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_sni_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_renegotiate ),
		Znk_DOTINIT( clienthello_needs, tlsext_ri_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_ri_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_ri_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_ri_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_ri_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_ri_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_status_request ),
		Znk_DOTINIT( clienthello_needs, tlsext_ocsp_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_ocsp_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_ocsp_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_ocsp_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_ocsp_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_ocsp_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_ec_point_formats ),
		Znk_DOTINIT( clienthello_needs, tlsext_ecpf_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_ecpf_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_ecpf_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_ecpf_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_ecpf_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_ecpf_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_elliptic_curves ),
		Znk_DOTINIT( clienthello_needs, tlsext_ec_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_ec_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_ec_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_ec_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_ec_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_ec_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_session_ticket ),
		Znk_DOTINIT( clienthello_needs, tlsext_sessionticket_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_sessionticket_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_sessionticket_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_sessionticket_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_sessionticket_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_sessionticket_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_signature_algorithms ),
		Znk_DOTINIT( clienthello_needs, tlsext_sigalgs_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_sigalgs_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_sigalgs_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_sigalgs_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_sigalgs_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_sigalgs_serverhello_parse ),
	},
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_application_layer_protocol_negotiation ),
		Znk_DOTINIT( clienthello_needs, tlsext_alpn_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_alpn_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_alpn_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_alpn_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_alpn_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_alpn_serverhello_parse ),
	},
#ifndef OPENSSL_NO_SRTP
	{
		Znk_DOTINIT( type, TLSEXT_TYPE_use_srtp ),
		Znk_DOTINIT( clienthello_needs, tlsext_srtp_clienthello_needs ),
		Znk_DOTINIT( clienthello_build, tlsext_srtp_clienthello_build ),
		Znk_DOTINIT( clienthello_parse, tlsext_srtp_clienthello_parse ),
		Znk_DOTINIT( serverhello_needs, tlsext_srtp_serverhello_needs ),
		Znk_DOTINIT( serverhello_build, tlsext_srtp_serverhello_build ),
		Znk_DOTINIT( serverhello_parse, tlsext_srtp_serverhello_parse ),
	}
#endif /* OPENSSL_NO_SRTP */
};
