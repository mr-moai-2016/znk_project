...
まあ我々としては、もはや**こんな化石のような定義**など、今更どうでもいいわけだが、 
「ハッカー」っていう言葉は、コンピュータで悪いことする犯罪者として今や覆しのないくらい社会に浸透しているのだし.

…とここまで書いておいてアレだが、他に適当な言葉も思いつかなかったので
このファイル名も多くのオープンソースプロジェクトがそうしているようにHackingという名前にしちゃいましたｗ
...
## <a name="cooking"></a>Cooking? クッキーって奴っすか？
-----------------------------------
※本製品は観賞用であり、食べられません.
...
## <a name="dependency"></a>各ソースの依存関係について
-----------------------------------
...
## <a name="moai_src"></a>moai本体のソースコードの構成について
-----------------------------------
