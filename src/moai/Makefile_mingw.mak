...
$(EXE_FILE0): $(OBJS0) $(RES_FILE0)
	@echo $(LINKER) -o $(EXE_FILE0) $(RES_FILE0) {[objs]} $(SUB_LIBS) $(MY_LIBS_ROOT)/libZnk/out_dir/$(ABINAME)/libZnk-$(DL_VER).dll.a $(MY_LIBS_ROOT)/libRano/out_dir/$(ABINAME)/libRano-$(DL_VER).dll.a $(MY_LIBS_ROOT)/libMoai/out_dir/$(ABINAME)/libMoai-$(DL_VER).dll.a -lws2_32 
	@     $(LINKER) -o $(EXE_FILE0) $(RES_FILE0) $(OBJS0) $(SUB_LIBS) $(MY_LIBS_ROOT)/libZnk/out_dir/$(ABINAME)/libZnk-$(DL_VER).dll.a $(MY_LIBS_ROOT)/libRano/out_dir/$(ABINAME)/libRano-$(DL_VER).dll.a $(MY_LIBS_ROOT)/libMoai/out_dir/$(ABINAME)/libMoai-$(DL_VER).dll.a -lws2_32 
