...
static char          st_current_dir_request[ 256 ] = "";
...
static bool          st_is_apk = false;

const char*
MoaiServerInfo_getCurrentDirRequest( void )
{
	return st_current_dir_request;
}
void
MoaiServerInfo_setCurrentDirRequest( const char* current_dir_request )
{
	ZnkS_copy( st_current_dir_request, sizeof(st_current_dir_request), current_dir_request, Znk_NPOS );
}
const char*
...
bool
MoaiServerInfo_is_apk( void )
{
	return st_is_apk;
}
void
MoaiServerInfo_set_is_apk( bool is_apk )
{
	st_is_apk = is_apk;
}
