...
BASENAME0=Moai
DLIB_NAME0=cygMoai-$(DL_VER).dll
DLIB_FILE0=$O/$(DLIB_NAME0)
ILIB_FILE0=$O/cygMoai-$(DL_VER).dll
...
$(DLIB_FILE0): $(OBJS0) $(SLIB_FILE0)
	...
	@echo gcc -shared -o $(DLIB_FILE0) {[objs]} $(SUB_LIBS) $(MY_LIBS_ROOT)/libZnk/out_dir/$(ABINAME)/cygZnk-$(DL_VER).dll $(MY_LIBS_ROOT)/libRano/out_dir/$(ABINAME)/cygRano-$(DL_VER).dll -lpthread -ldl -lstdc++  -lc
	@     gcc -shared -o $(DLIB_FILE0) $(OBJS0) $(SUB_LIBS) $(MY_LIBS_ROOT)/libZnk/out_dir/$(ABINAME)/cygZnk-$(DL_VER).dll $(MY_LIBS_ROOT)/libRano/out_dir/$(ABINAME)/cygRano-$(DL_VER).dll -lpthread -ldl -lstdc++  -lc
