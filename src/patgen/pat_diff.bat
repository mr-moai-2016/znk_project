...
win64\patgen diff ../releases_dir/v%old_ver%/moai-v%old_parent_ver%-android-armeabi-v7a ../moai-v%new_parent_ver%-android-armeabi-v7a > diff_android-armeabi-v7a.pmk
