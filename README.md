...
* 2016/07/03  【ニュース】  
  **ふたばの仕様変更により、古いfilterファイルでは表示が乱れる問題が発生します**.  
  最新のリリースにバージョンアップすることをお勧めします.  
  ( 最新のバージョンではこの問題の修正が行われています ).    

  以下に古いバージョンを使われている方のための回避方法を示しますが、  
  現在ふたばの仕様は頻繁に変更されているため、またすぐに問題が発生する可能性があります.  
  その場合は最新のリリースバージョンをお使いください.  

  **filters/futaba_recv.myf**をテキストエディタで開き、以下の文を次のように修正します.  
